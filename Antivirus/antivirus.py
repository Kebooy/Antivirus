...
# print("🔐 Ejecutando como administrador." if is_admin else "⚠️ No tienes privilegios de administrador."): Imprime un mensaje dependiendo de si el usuario es administrador o no. Usa un if en una sola línea (una forma compacta de escribirlo).
